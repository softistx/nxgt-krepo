...
| [`libs/stx-i18n/stx-i18n-spring/README.md`](libs/stx-i18n/stx-i18n-spring/README.md) | The Spring auto-configuration — why the narrowed locale resolver is the half that matters, and why Boot's own property wins |
...
| [`libs/stx-jpa/stx-jpa-spring/README.md`](libs/stx-jpa/stx-jpa-spring/README.md) | The Spring auto-configuration — why `packages` is required, and why the schema is somebody else's job |
