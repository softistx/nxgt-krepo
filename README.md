...
| `libs/shared-ktor` | Ktor integrations for the libraries here: `install(I18n)`, then `call.translate("key")` in a handler with the locale already decided — and the plugins for the rest as they land |
...
| [`libs/shared-ktor/README.md`](libs/shared-ktor/README.md) | The Ktor integrations — installing the i18n plugin, and how one module holds many without a fat dependency list |
