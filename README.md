...
Alongside it, `libs/shared-mongo` is a standalone library with no connection to the generator: the
MongoDB pieces a Kotlin coroutine service repeats — session-aware collection extensions, keyset
pagination, a CRUD repository and the write flow over it, and a coroutine GridFS bucket.
