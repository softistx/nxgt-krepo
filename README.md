...
| `libs/shared-koin` | The same six backends as Koin modules, for a worker or a CLI with no web framework: `redisModule(config)`, and the container closes what it built |
...
| [`libs/shared-ktor/README.md`](libs/shared-ktor/README.md) | The Ktor integrations — the six plugins, what each owns, and how one module holds them without a fat dependency list |
