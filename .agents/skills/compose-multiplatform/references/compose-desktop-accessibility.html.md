<!-- Generated from https://kotlinlang.org/docs/multiplatform/compose-desktop-accessibility.html (v) on 2026-08-28. Do not edit; re-run fetch_docs.py. -->

# Support for desktop accessibility features

Compose Multiplatform builds on top of [Jetpack Compose](https://developer.android.com/jetpack/compose), making most accessibility features available in common code across all platforms. The current status of accessibility support on desktop is as follows:
...
To test accessibility information for the elements in your application on macOS, you can use [Accessibility Inspector](https://developer.apple.com/documentation/accessibility/accessibility-inspector) (Xcode | Open Developer Tool | Accessibility Inspector):

On Windows, you can use the Show Speech History feature in [JAWS](https://www.freedomscientific.com/Products/Blindness/JAWS) or the Speech Viewer in [NVDA](https://www.nvaccess.org/):
