<!-- Generated from https://kotlinlang.org/docs/multiplatform/multiplatform-share-on-platforms.html (v) on 2026-08-28. Do not edit; re-run fetch_docs.py. -->
...
If you need to access platform-specific APIs from the shared code, use the Kotlin mechanism of [expected and actual declarations](multiplatform-expect-actual.html).
...
To share more native code without being limited by platform-specific dependencies, use [platform libraries](https://kotlinlang.org/docs/native-platform-libs.html), like Foundation, UIKit, and POSIX. These libraries are shipped with Kotlin/Native and available in shared source sets by default.

In addition, if you use the [Kotlin CocoaPods Gradle](multiplatform-cocoapods-overview.html) plugin in your projects, you can work with third-party native libraries consumed with the [`cinterop` mechanism](https://kotlinlang.org/docs/native-c-interop.html).

## What's next?

- [Read about the Kotlin's mechanism of expected and actual declarations](multiplatform-expect-actual.html)
- [Learn more about hierarchical project structure](multiplatform-hierarchy.html)
- [Set up the publication of your multiplatform library](multiplatform-publish-lib-setup.html)
