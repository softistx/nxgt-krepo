<!-- Generated from https://kotlinlang.org/docs/multiplatform/supported-platforms.html (v) on 2026-08-28. Do not edit; re-run fetch_docs.py. -->
...
- Kotlin Multiplatform supports more native platforms than are listed here. To understand the level of support for each of them, see [Kotlin/Native target support](https://kotlinlang.org/docs/native-target-support.html).
- For more information on the stability levels of Kotlin components like Kotlin Multiplatform, see [Current stability of Kotlin components](https://kotlinlang.org/docs/components-stability.html#current-stability-of-kotlin-components).
...
See [Recommended IDEs](recommended-ides.html) to learn which IDE is better for your code-sharing scenario across different combinations of platforms.
