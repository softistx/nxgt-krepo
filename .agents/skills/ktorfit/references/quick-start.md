<!-- Generated from https://foso.github.io/Ktorfit/quick-start/ (v) on 2026-08-26. Do not edit; re-run fetch_docs.py. -->

# Quick start

First do the [Installation](../installation/)

Let’s say you want to make a GET Request to [https://swapi.dev/api/people/1/](https://swapi.dev/api/people/1/)
...
An interface used for Ktorfit needs to have a HTTP method annotation on every function. Because Ktor relies on Coroutines by default your functions need to have the **suspend** modifier. Alternatively you can use [#Flow](../converters/responseconverter#flow) or [Call](../converters/responseconverter#call)
