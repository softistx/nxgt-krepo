...
filter operator, a page. This is the half of `libs/core/stx-spring-boot` that gains an entry every phase,
...
[`libs/core/stx-spring-boot/README.md`](../libs/core/stx-spring-boot/README.md) has the rest: the opt-in
