...
This is the release line for `io.github.softistx:stx-kafka`, `io.github.softistx:stx-kafka-ktor` and `io.github.softistx:stx-kafka-spring` — the **stx-kafka** family. They carry one version between them and ship together.
