...
// than in every library that talks to it: stx-mongo should say what it needs, not how to
 ...
 * speaks JDBC — `stx-jpa` is reactive from the driver up — so that probe throws *"Could not get
 ...
 * started: `stx-jpa` ships the driver, and the specs that would exercise it run only where a
 * server is named.
 */
