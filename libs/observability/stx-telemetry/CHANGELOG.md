...
This is the release line for `io.github.softistx:stx-telemetry`, `io.github.softistx:stx-telemetry-ktor`, `io.github.softistx:stx-telemetry-mongo`, `io.github.softistx:stx-telemetry-otlp`, `io.github.softistx:stx-telemetry-slf4j` and `io.github.softistx:stx-telemetry-spring` — the **stx-telemetry** family. They carry one version between them and ship together.
