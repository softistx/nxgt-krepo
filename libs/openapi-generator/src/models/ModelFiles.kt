 ...
 */
internal fun modelFiles(model: ApiModel, options: EmitOptions, style: ModelStyle): List<FileSpec> =
    model.models.map { modelFile(it, options, style) }

private fun modelFile(model: ModelType, options: EmitOptions, style: ModelStyle): FileSpec {
