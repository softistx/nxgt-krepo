 ...
 */
public class TypeStyle(public val instant: TypeName, public val freeForm: TypeName)

/** The one place a [TypeRef] becomes a Kotlin type, so every emitter agrees on the mapping. */
public fun typeNameOf(type: TypeRef, options: EmitOptions, style: TypeStyle): TypeName = when (type) {
