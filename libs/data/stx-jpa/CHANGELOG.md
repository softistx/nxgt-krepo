...
This is the release line for `io.github.softistx:stx-jpa`, `io.github.softistx:stx-jpa-ktor` and `io.github.softistx:stx-jpa-spring` — the **stx-jpa** family. They carry one version between them and ship together.
