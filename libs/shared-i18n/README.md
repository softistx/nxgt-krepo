...
[`libs/shared-ktor-i18n`](../shared-ktor-i18n/README.md) for the server plugin over it.
...
## Why this is not in shared-common

ICU4J is a 15 MB jar. `shared-common`'s rule is kotlinx-and-nothing-else, and putting message
formatting in it would make `shared-kafka` carry a formatting library it will never call.
